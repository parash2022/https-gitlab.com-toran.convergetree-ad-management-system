...
class AdController extends Controller
{
    ...
    public function store(AdRequest $request)
    {
        ...
        return redirect()->route('administrator.ads.create')->with(['alert' => ['class' => 'success', 'msg' => __('New ad added!')]]);
    }
    ...
    public function update(AdRequest $request)
    {
        ...
        // else Thumbnail::unlinkUpload($request->old_featured_photo);
    ...
    public function delete(Request $request)
    {
        ...
        if ($ad) {
            ...
            // Thumbnail::unlinkUpload($ad->image);
