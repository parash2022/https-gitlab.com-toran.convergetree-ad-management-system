    ...
    $noticeRoutes   = ['administrator.notification.index', 'administrator.notification.create', 'administrator.notification.edit'];
    $appUserRoutes  = ['administrator.notification.appUser'];
    ...
    <div class="br-sideleft sideleft-scrollbar">
      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub @if(in_array($routeName,$noticeRoutes)) active @endif">
            <i class="menu-item-icon icon ion-ios-bell-outline tx-22"></i>
            <span class="menu-item-label">Push Notification</span>
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{route('administrator.notification.index')}}" class="sub-link @if($routeName == 'administrator.notification.index') active @endif">All Notification</a></li>
            <li class="sub-item"><a href="{{route('administrator.notification.create')}}" class="sub-link @if($routeName == 'administrator.notification.create') active @endif">Add New</a></li>
          </ul>
        </li>
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub @if(in_array($routeName,$appUserRoutes)) active @endif">
            <i class="menu-item-icon icon ion-ios-people-outline tx-22"></i>
            <span class="menu-item-label">App Users</span>
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{route('administrator.notification.appUser')}}" class="sub-link @if($routeName == 'administrator.notification.appUser') active @endif">All Users</a></li>
          </ul>
        </li>
