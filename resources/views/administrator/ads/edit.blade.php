...
<?php
$adCategory = $ad->categories;
$catID = [];
if (isset($adCategory)) {

  foreach ($adCategory as $aCat) {
    array_push($catID, $aCat->id);
  }
}
?>
    ...
    <div class="row mg-t-20">
      ...
      <div class="col-sm-8 mg-t-10 mg-sm-t-0">
        <select name="cat[]" class="form-control" id="ad-subcategory" multiple>
          ...
          <?php
          if ($catID[0] != '') {
            $subCategory = CategoryController::getSubCategory($catID[0]);
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    data = [];
    data = <?php echo json_encode($catID) ?>;
    $('#ad-subcategory').val(data);
    $('#ad-subcategory').trigger('change');
  });
</script>
